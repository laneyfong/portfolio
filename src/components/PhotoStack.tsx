          ...
          <picture>
            ...
            <img
              ...
              style={{
                ...
                height: "100%",
                objectFit: "cover",
                objectPosition: photos[currentIndex].rotate ? "center center" : "50% 55%",
                display: "block",
                transform: photos[currentIndex].rotate ? `rotate(${photos[currentIndex].rotate}deg) scale(1.4)` : "rotate(0deg)",
